...
setup(
    ...
    ext_modules=[CUDAExtension('layers._C',
        # ['csrc/extensions.cpp', 'csrc/engine.cpp', 'csrc/cuda/decode.cu', 'csrc/cuda/decode_rotate.cu', 'csrc/cuda/nms.cu', 'csrc/cuda/nms_iou.cu'],
        ['csrc/extensions.cpp', 'csrc/cuda/decode.cu', 'csrc/cuda/decode_rotate.cu', 'csrc/cuda/nms.cu', 'csrc/cuda/nms_iou.cu'],
        extra_compile_args={
    ...
    cmdclass={'build_ext': BuildExtension.with_options(no_python_abi_suffix=True, with_ninja=False)},
    install_requires=[
        'torch>=1.0.0a0',
        'torchvision',
